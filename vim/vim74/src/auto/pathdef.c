...
char_u *all_lflags = (char_u *)"gcc   -L/usr/local/lib -Wl,--as-needed -o vim        -lm -ltinfo -lnsl  -lselinux          ";
char_u *compiled_user = (char_u *)"shitara";
char_u *compiled_sys = (char_u *)"ansible";
